...
class TrainArguments(SwanlabArguments, TunerArguments, BaseArguments, Seq2SeqTrainingOverrideArguments):
    ...
    def __post_init__(self) -> None:
        ...
        # DGO uses dgo_data_file instead of dataset, skip validation for it
        skip_dataset_check = getattr(self, 'rlhf_type', None) == 'dgo' and getattr(self, 'dgo_data_file', None)
        if len(self.dataset) == 0 and len(self.cached_dataset) == 0 and not skip_dataset_check:
